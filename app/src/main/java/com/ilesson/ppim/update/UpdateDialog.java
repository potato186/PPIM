...
public class UpdateDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(getArguments().getString(Consts.APK_UPDATE_CONTENT))
    ...
    private void goToDownload() {
    	...
    	intent.putExtra(Consts.APK_DOWNLOAD_URL, getArguments().getString(Consts.APK_DOWNLOAD_URL));
