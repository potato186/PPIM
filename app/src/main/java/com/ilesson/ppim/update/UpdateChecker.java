...
public class UpdateChecker extends Fragment {
	...
	private void parseJson(String json) {
		...
		try {
			...
			String updateMessage = obj.getString(Consts.APK_UPDATE_CONTENT);
			String apkUrl = obj.getString(Consts.APK_DOWNLOAD_URL);
	...
	public void showDialog(String content,String apkUrl) {
		...
		Bundle args = new Bundle();
		args.putString(Consts.APK_UPDATE_CONTENT, content);
		args.putString(Consts.APK_DOWNLOAD_URL, apkUrl);
		d.setArguments(args);
	...
	public void showNotification(String content,String apkUrl) {
		...
		myIntent.putExtra(Consts.APK_DOWNLOAD_URL, apkUrl);
