...
@MessageTag(value = "custom:pay", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class PPayMessage extends MessageContent {
    ...
    * */
     ...
     */
    public static final Creator<PPayMessage> CREATOR = new Creator<PPayMessage>() {

        @Override
        public PPayMessage createFromParcel(Parcel source) {
            return new PPayMessage(source);
        }

        @Override
        public PPayMessage[] newArray(int size) {
            return new PPayMessage[size];
        }
    };
