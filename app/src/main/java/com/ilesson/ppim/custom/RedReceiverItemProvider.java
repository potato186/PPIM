 ...
 */
@ProviderTag(
        messageContent = RedReceiverMessage.class,//（这里是你自定义的消息实体）
        showReadState = true,showPortrait = false,centerInHorizontal = true,showSummaryWithName = false
)
public class RedReceiverItemProvider extends IContainerItemProvider.MessageProvider<RedReceiverMessage> {

    public RedReceiverItemProvider() {
    }
    ...
    @Override
    public void bindView(View view, int i, RedReceiverMessage msg, UIMessage message) {
    ...
    @Override
    public Spannable getContentSummary(RedReceiverMessage redPackageMessage) {
...
//    <string name="transfer_summary">[转账]请你确认收款</string>
    @Override
    public void onItemClick(View view, int i, RedReceiverMessage redPackageMessage, UIMessage uiMessage) {
        showProgress();
    ...
    @Override
    public void onItemLongClick(View view, int position, final RedReceiverMessage content, final UIMessage message) {
//        String[] items1;
...
//        }).show();
    ...
    private void check(final String groupId,final RedReceiverMessage message) {
...
//        params.addBodyParameter("id", message.getRedpacketId());
    ...
    private void showRedDialog(final String grouId,final CheckRedpacketData data,final RedReceiverMessage message) {
...
//                desTV.setText(message.getDes());
    ...
    private void checkRed(boolean has,RedReceiverMessage message,String grouId){
