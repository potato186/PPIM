...
public class UrlUtil {
    ...
    public static final String BUSER="/buser.html";
    public static final String BPRIVACY="/bprivacy.html";
    public void privacy(Context context,String page, String title){
        Intent intent = new Intent(context, WebActivity.class);
        intent.putExtra(WebActivity.URL,Constants.BASE_URL+page);
