...
public class StatusBarUtil {
     ...
     */
    public static void setBarPadding(Context context,View view) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            view.setPadding(view.getPaddingLeft(), DensityUtil.dip2px(8),view.getPaddingRight(), view.getPaddingBottom());
        } else {
            view.setPadding(view.getPaddingLeft(), StatusBarUtil.getStatusBarHeight(context), view.getPaddingRight(), view.getPaddingBottom());
        }
    }
    /**
     * 使状态栏半透明
