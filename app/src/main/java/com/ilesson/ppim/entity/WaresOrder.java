...
public class WaresOrder implements Serializable {
    ...
    public String getInvoice_mediumName() {
        return invoice_mediumName;
    }

    public void setInvoice_mediumName(String invoice_mediumName) {
        this.invoice_mediumName = invoice_mediumName;
    }
    ...
    public String getInvoice_typeName() {
        return invoice_typeName;
    }

    public void setInvoice_typeName(String invoice_typeName) {
        this.invoice_typeName = invoice_typeName;
    }
