...
import com.ilesson.ppim.activity.ImageSelectorActivity;
...
public class ImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImageListAdapter(Context context, int maxSelectNum, int mode, boolean showCamera, boolean enablePreview, int alreadyNum) {
...
//                    .dontAnimate()
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (selectImages.size() >= maxSelectNum - alreadyNum && !isChecked) {
